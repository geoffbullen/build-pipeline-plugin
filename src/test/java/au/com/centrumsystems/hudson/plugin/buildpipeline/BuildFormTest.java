...
public class BuildFormTest extends HudsonTestCase {
	...
	public void testConstructor() throws Exception {
		...
		assertThat(bf.getDependencies().get(0).getName(), is(project2
				.getLastBuild().toString()));
		assertThat(bf.getStartTime(), containsString(TimeZone.getDefault()
				.getDisplayName(true, TimeZone.SHORT)));
		assertThat(bf.getBuildProgress(), is(0L));
	}
}
