...
public class BuildPipelineViewConstructorTest {
    ...
    public void testAlwaysAllowManualTrigger() throws IOException {
        ...
        // True
        BuildPipelineView testView = new BuildPipelineView(bpViewName, bpViewTitle, proj1, noOfBuilds, true, true, false, 2);
        assertTrue(testView.isAlwaysAllowManualTrigger());

        // False
        testView = new BuildPipelineView(bpViewName, bpViewTitle, "", noOfBuilds, true, false, false, 2);
    ...
    public void testShowPipelineParameters() throws IOException {
        ...
        // True
        BuildPipelineView testView = new BuildPipelineView(bpViewName, bpViewTitle, proj1, noOfBuilds, true, false, true, 2);
    ...
    public void testRefreshFrequency() throws IOException {
        ...
        // False
        final BuildPipelineView testView = new BuildPipelineView(bpViewName, bpViewTitle, "", noOfBuilds, true, false, false, 2);
